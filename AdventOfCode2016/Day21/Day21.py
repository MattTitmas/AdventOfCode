    ...
    for operation in operations:
        if operation[0] == "rotate":
            if operation[1] == "based":
                val = (
                    key.index(operation[-1])
                    + 1
                    + (1 if key.index(operation[-1]) >= 4 else 0)
                )
            ...
            if operation[1] == "position":
                ...
                stringList[int(operation[2])], stringList[int(operation[5])] = (
                    stringList[int(operation[5])],
                    stringList[int(operation[2])],
                )
                key = "".join(stringList)
            else:
                stringList = list(key)
                (
                    stringList[key.index(operation[2])],
                    stringList[key.index(operation[5])],
                ) = (
                    stringList[key.index(operation[5])],
                    stringList[key.index(operation[2])],
                )
