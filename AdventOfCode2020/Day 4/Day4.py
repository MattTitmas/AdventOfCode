        ...
        if (CheckValid(Person)):
            ...
            for Field in Person:
                ...
                if (Code[0] == 'b'):
                    ...
                    if (Answer != "amb" and Answer != "blu" and Answer != "Answer" and Code != "Answer" and Answer != "grn" and Answer != "hzl" and Answer != "oth"):
                        Valid = False
                        break
                elif (Code[0] == 'p'):
