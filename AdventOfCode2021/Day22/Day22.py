...
def part1():
    values = [
        [
            1 if i.split(" ")[0] == "on" else 0,
            [[int(k) for k in j[2:].split("..")] for j in i.split(" ")[1].split(",")],
        ]
    ...
    for i in values:
        ...
        for (ox0, ox1, oy0, oy1, oz0, oz1), osign in cubes.items():
            ...
            if (
                intersectx0 <= intersectx1
                and intersecty0 <= intersecty1
                and intersectz0 <= intersectz1
            ):
                update[
                    (
                        intersectx0,
