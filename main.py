...
if __name__ == "__main__":
    ...
    if not args.allDays:
        input_path = str(ROOT / ("Advent of code/AdventOfCode"+str(args.year)+"/Inputs/input"+str(args.day)+".txt"))
        day = Day1(input_path)
        ...
        for i in range(25):
            print(f'Day {i+1}:')
            currentDay = i + 1
            input_path = str(ROOT / ("Advent of Code/AdventOfCode2017/Inputs/input" + str(currentDay) + ".txt"))
            day = Day1(input_path)
